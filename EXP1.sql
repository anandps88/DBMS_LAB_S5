...
SELECT C1.NAME AS CUSTOMER1, C2.NAME AS CUSTOMER2, P.ORDER_NO, P.ORDERDATE FROM CUSTOMER C1 INNER JOIN CUSTOMER C2 ON C1.CITY = C2.CITY AND C1.CUST_NO <> C2.CUST_NO INNER JOIN PURCHASE P ON C1.CUST_NO = P.CUSTNO ORDER BY C1.NAME, C2.NAME;
